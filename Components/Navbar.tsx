...
// const MyDropdown = () => {
//   // Initialize dropdown when the component mounts
//   useEffect(() => {
//     const dropdownToggleElement = document.getElementById('dropdownButton');
  ...
  return (
    <nav className='bg-black text-white flex justify-between items-center md:h-16 flex-col md:flex-row px-4'>
      ...
      <div className='logo font-bold text-lg flex justify-center items-center gap-2'>
        ...
        <Link href={'/'}><img src="/rudder-4981.gif" alt="logo" width={35} /> </Link>
        <Link href={'/'}><div><span>Oceanic</span><span className="text-[#63e]">Edge</span><span>!</span></div> </Link>

...
>>>>>>> 160a82c4f9bf61217aff5ca8fbb56e23e440e753
...
//       {/* Hero Section */}
//       <section className="gif flex flex-col items-center justify-center text-center pt-24 pb-72 px-4 w-full">
...
//       {/* About Section */}
//       <section id="about" className="py-16 px-4 bg-[#4a809b] text-center w-full">
//         <h2 className="text-4xl font-bold mb-6">About Us</h2>
...
//       {/* Features Section */}
//       <section id="features" className="py-16 bg-gradient-to-r from-[#4a809b] via-[#3a6a84] to-[#2a526c] text-white w-full">
//         <div className="text-center">
//           <h2 className="text-4xl font-bold mb-8">Features for Students</h2>
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-6 w-full">
//             {/* Feature 1 */}
//             <div className="p-6 bg-gradient-to-r from-green-400 to-green-600 rounded-lg shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105">
